#!/usr/bin/env sh
# Universal installer for biascope. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/biascope.git"
echo "Installing biascope ..."
