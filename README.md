...
```bash
biascope --version
biascope scan demos/                          # run against bundled demo
biascope scan demos/ --format sarif --out r.sarif --fail-on high
biascope mcp                                   # start as MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
- `demos/01-loan-approval/` — see [`SCENARIO.md`](demos/01-loan-approval/SCENARIO.md)
- `demos/02-clean-chatbot/` — see [`SCENARIO.md`](demos/02-clean-chatbot/SCENARIO.md)
- `demos/03-customer-segmentation/` — see [`SCENARIO.md`](demos/03-customer-segmentation/SCENARIO.md)
